...
2. **Create the tabs.** Select `setupSheets` in the toolbar dropdown and
...
3. **Create the admin account.** Scroll to `ADMIN_BOOTSTRAP_EMAIL` /
...
5. **Wire up the frontend.** Every page except `404.html` has its own copy
...
6. **Push to GitHub.** GitHub Pages serves the site automatically once the
